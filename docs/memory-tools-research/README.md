...
| [codex-agent-mem](codex-agent-mem.md) | [MarceloCaporale/codex-agent-mem](https://github.com/MarceloCaporale/codex-agent-mem) | npm name unavailable 2026-05-24; older `1.0.2` evidence | Cross-session continuity, open work, closure checks, compact context packs. | Degraded availability; использовать только для user-owned/reviewed install или explicit DB notes, не install по старому npm имени. |
