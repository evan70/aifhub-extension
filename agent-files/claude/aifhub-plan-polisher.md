...
- Return concise output with: active OpenSpec change, canonical artifacts inspected or touched, effective policy summary, generated rules state, runtime state path, QA evidence path, critique status, remaining issues, and whether more refinement is recommended.
